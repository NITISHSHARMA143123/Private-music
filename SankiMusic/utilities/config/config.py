...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "𝐂𝐨𝐜𝐤𝐓𝐚𝐢𝐋 ✘ 𝐌ʋsɩƈ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5336023580").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/NITISHSHARMA143123/Private-music")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "aditya")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/darkk_diary")
